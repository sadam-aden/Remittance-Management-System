...
"Use r/reference/remittance-dashboard.jsx as the canonical design reference for the whole app — same dark theme, color tokens, typography, and card style. Reuse its exact hex values and font choices across every other page (Customers, Income, Reports, etc.), not just the dashboard."
